...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the BasicCNN baseline on the realistic v2 dataset.")
    ...
    parser.add_argument("--experiment-name", default="BasicCNN_v2_realistic")
