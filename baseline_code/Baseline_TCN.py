...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a dilated TCN baseline on the realistic v2 dataset.")
    ...
    parser.add_argument("--experiment-name", default="TCN_v2_realistic")
