...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a plain 1D U-Net baseline on the realistic v2 dataset.")
    ...
    parser.add_argument("--experiment-name", default="UNet1D_v2_realistic")
